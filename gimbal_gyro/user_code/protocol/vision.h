...
extern VisionActData_t VisionActData; //行动模式结构体

extern VisionRecvData_t VisionRecvData; //接收数据结构体

extern VisionSendData_t VisionSendData; //发送数据结构体
