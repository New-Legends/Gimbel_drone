...
#define GIM_MOTOR 1
    ...
    /*------------------------------陀螺仪PID------------------------*/
    // yaw轴陀螺仪PID 由陀螺仪角度控制
    #define YAW_GYRO_PID_KP 9.0f  //20.0
    #define YAW_GYRO_PID_KI 0.1f
    #define YAW_GYRO_PID_KD 25.0f     //12.0f
    ...
    /*------------------------------编码器PID------------------------*/
    // yaw轴编码器PID 由编码器角度控制
    #define YAW_ENCODE_PID_KP 35.0f
    #define YAW_ENCODE_PID_KI 0.01f
    #define YAW_ENCODE_PID_KD 5.0f
...
//云台中值(中值所对应的编码器编码值)
#define ECD_YAW_MID 6850
#define ECD_PITCH_MID 67
...
// //云台初始化回中值的速度以及控制到的角度
#define GIMBAL_TO_MID_PITCH_SPEED 0.0005f 
